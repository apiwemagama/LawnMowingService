...
namespace LawnMowingService.Controllers
{
    public class MachinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MachineId,MachineName,IsAvailable")] Machine machine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MachineId,MachineName,IsAvailable")] Machine machine)
        {
