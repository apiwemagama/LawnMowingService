...
namespace LawnMowingService.Controllers
{
    public class OperatorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OperatorId,MachineId,OperatorName")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OperatorId,MachineId,OperatorName")] Operator @operator)
        {
